...
inherit eutils python-single-r1 waf-utils multilib-minimal vcs-snapshot
...
if [[ "${PV}" = "2.9999" ]]; then
	...
	SRC_URI="https://github.com/jackaudio/jack2/archive/v1.9.11-RC1.tar.gz -> jack2-${PV}.tar.gz"
	KEYWORDS="~amd64 ~ppc"
fi
